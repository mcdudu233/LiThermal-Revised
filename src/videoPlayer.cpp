...
static uint8_t IR_frame_buffer[320 * 240 * 4];
static pthread_t thread_image_ref;
static sem_t sem_video;

static int thread_video_command = CMD_NONE;
  ...
  while (1) {
    ...
    case STATE_PLAYING: {
      ...
      av_image_copy_to_buffer(IR_frame_buffer, sizeof(IR_frame_buffer),
                              ...
                              (const int *)frame->linesize, AV_PIX_FMT_RGBA,
