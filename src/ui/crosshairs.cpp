...
void ui_crosshairs_create()
{
    ...
    lv_obj_set_style_text_color(crosshairs_label_max, lv_color_make(0xFF, 0x00, 0x00), 0);
    ...
    lv_obj_set_style_text_color(crosshairs_label_min, lv_color_make(0x00, 0x00, 0xFF), 0);
