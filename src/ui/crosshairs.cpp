...
void ui_crosshairs_updatePos() {
  ...
  if (hidden_by_view == false && current_mode != MODE_MAINPAGE &&
...
void ui_crosshairs_create() {
  ...
  lv_obj_align_to(crosshairs_label_max, crosshairs_max, LV_ALIGN_OUT_RIGHT_MID,
                  0, 0);
  ...
  lv_obj_align_to(crosshairs_label_min, crosshairs_min, LV_ALIGN_OUT_RIGHT_MID,
                  0, 0);
