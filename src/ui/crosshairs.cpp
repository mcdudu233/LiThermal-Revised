...
void ui_crosshairs_create()
{
    ...
    lv_obj_set_style_text_color(crosshairs_label_max, lv_color_make(0xEC, 0x8E, 0x9C), 0);
    ...
    lv_obj_set_style_text_color(crosshairs_label_min, lv_color_make(0x87, 0xCE, 0xEB), 0);
